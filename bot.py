...
# =====================================================  LOAD MODELS ==================================================
dtc , le  = pk.load(open('C:\\Users\\user\\Downloads\\software proj\\chatbot_modelsave','rb'))
model,second_le  = pk.load(open('C:\\Users\\user\\Downloads\\software proj\\chatbot_model','rb'))
ners = pk.load(open('C:\\Users\\user\\Downloads\\software proj\\chatbot_modelsave','rb'))
